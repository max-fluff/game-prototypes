...
namespace WinFormsCli
{
    public static class ClipboardWrapper
    {
        public static void SetClipboard(string pathToImage)
        {
            var image = (Bitmap) Image.FromFile(pathToImage, true);
            SetClipboardImage(image, null, new DataObject());
        }
